 ...
 * ------------------------ */
   ...
   public double [] getVectorReference() {
       return A[0];
   }
 ...
 * ------------------------ */
   ...
   */
    ...
    * @return 
    */
   public Matrix times(double [] _v) {
       return this.times(new Vector(_v).transpose()).transpose();
   }
 ...
 * ------------------------ */
  ...
  private static final long serialVersionUID = 1;
    ...
    public double doubleSingleValue() {
        if (A.length == 1 && A[0].length == 1) {
            return A[0][0];
        }
        throw new RuntimeException("Invalid Matrix size: " + A.length + " x " + A[0].length);
    }
    ...
    public String toString() {
        ...
        for (int i=0;i<A.length;i++) {
            for (int j=0;j<A[i].length;j++) {
                ret = ret + df.format(A[i][j]).replaceAll(",", ".");
                if (j < A[i].length-1) {
                    ret = ret + ",";
                }
            }
