...
//        }
        ...
        BFGS<Float64> n = new BFGS<Float64>();
        ...
        n.setNumberfactory((NumberFactory<Float64>) new Float64NumberFactory());
        
        NewtonRaphson<Float64> linesearch = new NewtonRaphson<Float64>();
        linesearch.setMaxiterations(10);
        linesearch.setPrecision(Float64.valueOf(0.000000001));
