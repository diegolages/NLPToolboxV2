 ...
 * @author Diego
 */
public class MainBFGSRestriction {
...
//
//        ExpressionFunction f2 = new ExpressionFunction("x1^2");
...
//
//        ExpressionFunction r2 = new ExpressionFunction("-x1+3");
//        r2.setNumberfactory(new Float64NumberFactory());
//
...
//
//        f2.setNumberfactory(new Float64NumberFactory());
//        Float64 ix1 = Float64.valueOf(1.5);
//
...
//        linesearch.setPrecision(FloatingPoint.valueOf(0.0000000001));
//        bfgs.setLinesearch(linesearch);
//
//        //PenaltyMinimizationMethod<Float64> n = new PenaltyMinimizationMethod(new Newton<Float64>(), restrictions, null);
//        BarrierMinimizationMethod<Float64> n = new BarrierMinimizationMethod(bfgs, restrictions, null);
//        n.setInitialc(Float64.valueOf(10000));
