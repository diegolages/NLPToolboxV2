 ...
 * @author Diego
 */
public class ConjugateDescendent<F extends Field<F>> extends ConjugateGradient<F> implements MinimizationMethod<F> {
    ...
    protected F getBeta(Vector<F> deltaxn, Vector<F> deltaxn_1,Vector<F> lambdaxn_1,Function<F> function, Vector<F> xn) {
        ...
        return deltaxn.times(deltaxn).times(  lambdaxn_1.times(deltaxn_1).opposite().inverse()    );
