 ...
 * @author Diego
 */
public class MultiplePlaneBarrierMinimizationMethod<F extends Field<F>> implements ConstrainedMinimizationMethod<F> {
    ...
    public MultiplePlaneBarrierMinimizationMethod(MinimizationMethod mm, List<PlaneBarrierRestriction> fs) {
    ...
    public Vector minimize(Function f) throws Exception {
        ...
        do {
            ...
            oldr2 = r2;
            r2 = minimizationmethod.minimize(new ParMultiplePlaneBarrierCompositeFunction(f, initialpoint.getDimension(), functions, f64.doubleValue()));
...
//                jep.addVariable("x" + (i + 1), vx.get(i).doubleValue());
//            }
//
