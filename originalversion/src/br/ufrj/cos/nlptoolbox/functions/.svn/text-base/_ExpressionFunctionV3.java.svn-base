 ...
 * @author Diego
 */
public class _ExpressionFunctionV3<F extends Field<F>> implements NumberFactoryableFunction<F> {
    ...
    protected _ExpressionFunctionV3(String exp) throws Exception {
        this(exp, 0);
    }

    protected _ExpressionFunctionV3(String exp, int _nvariables) throws Exception {
    ...
    protected _ExpressionFunctionV3(String exp, int _nvariables, HashMap<String, Double> p) throws Exception {
        ...
        String javasource = "\n" +
                ...
                "\n" +
                "\n" +
                "public class " + tempfile.getName().replace(".java", "") + " implements Function<Float64> {\n";
...
//                        gexps2.add("F_h_" + (i+1) + "_" + (j+1));
                            ...
                            sb_hessianmatrixsource.append("Float64 F_h_" + (i2 + 1) + "_" + (j2 + 1) + " = Float64.valueOf(" + getNodeString(hnode) + ");\n");
        ...
        if (hessianmatrixsource.contains("x")) {
            ...
            hessiansource = hessiansource + " private void initCachedhessian(Matrix m) { \n";
        ...
        Callable<Boolean> task =
                jc.getTask(null, manager, null, null, null, jFiles);
        task.call();
        ...
        try {
            ...
            Class cls = cl.loadClass(tempfile.getName().replace(".java", ""));
            ...
            deletefile = false;
            System.out.println("Error instantiating classe for function: " + exp);
            System.err.println("Error instantiating classe for function: " + exp);
