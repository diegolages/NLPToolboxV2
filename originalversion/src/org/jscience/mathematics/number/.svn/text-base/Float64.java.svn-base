...
public final class Float64 extends Number<Float64> implements Field<Float64> {
     ...
     */
    final public Float64 plus(Float64 that) {
        Float64 r = FACTORY.object();
     ...
     */
    final public Float64 plus(double value) {
        Float64 r = FACTORY.object();
     ...
     * @return <code>this - that</code>.
     */
    final public Float64 minus(Float64 that) {
        Float64 r = FACTORY.object();
        r._value = this._value - that._value;
        return r;
    }
     ...
     * @return <code>this - value</code>.
     */
    final public Float64 minus(double value) {
        Float64 r = FACTORY.object();
        r._value = this._value - value;
        return r;
    }
     ...
     * @return <code>this · that</code>.
     */
    final public Float64 times(Float64 that) {
        Float64 r = FACTORY.object();
        r._value = this._value * that._value;
        return r;
    }
     ...
     * @return <code>this · value</code>.
     */
    final public Float64 times(double value) {
        Float64 r = FACTORY.object();
        r._value = this._value * value;
        return r;
    }
     ...
     * @return <code>this / that</code>.
     */
    final public Float64 divide(Float64 that) {
        Float64 r = FACTORY.object();
        r._value = this._value / that._value;
        return r;
    }
     ...
     * @return <code>this / value</code>.
     */
    final public Float64 divide(double value) {
        Float64 r = FACTORY.object();
        r._value = this._value / value;
        return r;
    }
